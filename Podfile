...
#
#  # 基础UI扩展
#  pod "BCUIKit", :tag => "1.0.0", :subspecs => ["Core", "Input",  "ScrollView", "Label"], :git => "git@gitlab.leke.cn:health-huihui/app/ios/ios-component/BCUIKit.git", :inhibit_warnings => false, :branch => "master", use_remote => 1
